...
from .views import HomePage, ShopView, ShopViewAll, ShopDetailView, ProductCommentView, SearchResultsView, OrgShopView
...
urlpatterns = [
    ...
    path('org/<uuid:uuid>', OrgShopView.as_view(), name='org')
]
