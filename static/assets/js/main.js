...
$(document).ready(function(){
    $('#category-tabs li a').next('ul').hide();
  });
...
$('#sub-category-tabs > li a').click(function(event) {
    const category_id = event.target.getAttribute('data-id')
    $(`#sub_sub_id_${category_id}`).slideToggle('500');
})
